...
def run_analysis():
    ...
    # ── 콘솔 출력 ─────────────────────────────────────────────────────────────
    print("\n── 등판 실패 임계값 ──────────────────────────────────────")
    print(f"  pitch_delta_threshold : {thresholds['pitch_delta_threshold']}")
...
<div class="grid">
  <div class="card">
    <div class="key">pitch_delta_threshold (등판 실패)</div>
    <div class="val">{thr['pitch_delta_threshold']}</div>
  ...
  <div class="card">
    <div class="key">slip_accel_ratio_threshold (슬립)</div>
    <div class="val">{thr['slip_accel_ratio_threshold']}</div>
